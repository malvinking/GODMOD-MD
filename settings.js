...
global.owner = process.env.OWNER_NUMBER  || '94761299352' ;  // ADD YOUR NUMBER WITHOUT +
    
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'youre session id' ,VAJIRA-MD=PM9D2KiJ#9g9F3HaXpR5Y1Y-5a12-8wfAUunNT6dPZkCQoFrvZXY
